...
public class Test {
    ...
    public static void main(String[] args) {
         ...
         Point point1 = new Point();
          ...
          l1.setEndPoint(p2);
          System.out.println("X koordinate pocetne tacke l1: " +
          l1.getStartPoint().getX());
          System.out.println("Y koordinate pocetne tacke l1: " +
          ...
          System.out.println("X koordinata pravougaonika r1: " +
          r1.getUpperLeftPoint().getX());
          System.out.println("Y koordinata pravougaonika r1: " +
